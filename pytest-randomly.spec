...
Version  : 3.10.2
Release  : 38
URL      : https://files.pythonhosted.org/packages/57/b1/f27037dfdc5bb8e82fb55967b85a5cea0d26da1eacc4866bea56b3b33119/pytest-randomly-3.10.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/57/b1/f27037dfdc5bb8e82fb55967b85a5cea0d26da1eacc4866bea56b3b33119/pytest-randomly-3.10.2.tar.gz
...
%prep
%setup -q -n pytest-randomly-3.10.2
cd %{_builddir}/pytest-randomly-3.10.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636647319
...
cp %{_builddir}/pytest-randomly-3.10.2/LICENSE %{buildroot}/usr/share/package-licenses/pytest-randomly/357dd8dc959a96d3bc13e11e940ccc7dd955492b
