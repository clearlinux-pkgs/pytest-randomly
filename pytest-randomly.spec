...
Version  : 3.10.0
Release  : 33
URL      : https://files.pythonhosted.org/packages/b2/83/77e245335473bcbc9edc4908e66a1ea32468d8652bc56238efc676f4e313/pytest-randomly-3.10.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/b2/83/77e245335473bcbc9edc4908e66a1ea32468d8652bc56238efc676f4e313/pytest-randomly-3.10.0.tar.gz
...
%prep
%setup -q -n pytest-randomly-3.10.0
cd %{_builddir}/pytest-randomly-3.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628868506
...
cp %{_builddir}/pytest-randomly-3.10.0/LICENSE %{buildroot}/usr/share/package-licenses/pytest-randomly/357dd8dc959a96d3bc13e11e940ccc7dd955492b
